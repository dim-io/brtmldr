...
4b. Haal het tijdelijke adres uit de workflow. Open `.github/workflows/pages.yml`, verwijder de twee regels `env:` en `SITE_BASE: /brtmldr` onder `node build.mjs`, en push die wijziging. Zolang die regels er staan, is de site gebouwd voor het tijdelijke adres dim-io.github.io/brtmldr/ en werken de links niet op je eigen domein.
